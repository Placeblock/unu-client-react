...
export default function CardGroupItem({cardGroup, onAmount, onDelete, disabled}) {
    return (
        <div className="card-group-item">
            {!disabled&&<button onClick={onDelete} 
                className="button negative-button delete-card-group-button">
                <FontAwesomeIcon icon={faTimes}></FontAwesomeIcon>
            </button>}
            {!disabled&&<div className="card-group-amount-container">
